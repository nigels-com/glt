...
:   QGLWidget(QGLFormat(QGL::DoubleBuffer|QGL::DepthBuffer|QGL::StencilBuffer),parent)
{
    ...
    cout << "GlutWidget::GlutWidget stencil=" << format().stencil() << endl;
    cout << "GlutWidget::GlutWidget autoBufferSwap=" << autoBufferSwap() << endl;
    #endif
}
...
{
    #ifdef DEBUG_THIS
    cout << "GlutWidget::initializeGL" << endl;
    #endif
...
void 
GlutWidget::resizeGL(int width, int height)
{
    #ifdef DEBUG_THIS
    cout << "GlutWidget::resizeGL" << endl;
    #endif
